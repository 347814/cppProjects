...
void deleteStudent(student** students, int indecies){
  ...
  if(strcmp(students[predictedIndex]->firstName, searchFirstName) == 0 && strcmp(students[predictedIndex]->lastName, searchLastName)){
...
void chainDelete(student* head, student* current, char* searchFirstName, char* searchLastName, int predictedIndex){
 ...
 //end of chain must be deleted
  else if(strcmp(current->next->firstName, searchFirstName) == 0 && strcmp(current->next->lastName, searchLastName) == 0 && current->next->next == NULL){
    delete current->next;


  }
  //something in the middle must be deleted
  else if(strcmp(current->next->firstName, searchFirstName) == 0 && strcmp(current->next->lastName, searchLastName) == 0 && current->next != NULL){
